...
if ! grep -q "^deb .*docker" /etc/ap/sources.list /etc/apt/sources.list.d/*; then
...
mkdir ~/bin
# install xmind
wget -nc -P ~/Downloads --header="User-Agent: Mozilla/5.0" https://www.xmind.net/xmind/downloads/xmind-8-update8-linux.zip
